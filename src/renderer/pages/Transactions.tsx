...
<iframe  sandbox="allow-forms allow-scripts allow-same-origin" src="https://sepolia-explorer.arbitrum.io/address/0x6519E04dEb2793F07b1b4756c922777F45B78880" style={{border:0,width:"100%",height:"100%"}} ></iframe>
    </div>
  );
}
